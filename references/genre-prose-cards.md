...
- 三者冲突时：本章蓝图（`spec.md`）与连续性 > `outline.md` 结构标记 > 题材卡 > 本书文风 > 通用技巧。

## 召回规则

1. 先读 `concept.md`，确认主题材、目标平台、性向频道、主对标书和核心梗。
...
4. 高置信卡可直接用于开书时生成的题材提示卡；中置信卡需结合本书对标/大纲对照；低置信卡只能兜底，必须标注低置信并优先补同题材对标。
5. 每章传给正文写手的 `genre_prose_card` 只保留本章相关条目，推荐 120-300 字；包含：题材限制、核心逻辑、读者期待、核心爽点/情绪、正文落点、前中后期打法、场景颗粒、禁止漂移、本章取舍、卡片置信度。
...
本地长篇样本不支持固定 50-60 字行宽、固定 50%-60% 对话占比、全局替换“地/得/很/像/顿号”、随机倒装、三胺八情或三翻四震等机械模板。题材卡只给“该题材更常用的场面和情绪落点”，具体段落仍按本章蓝图、文风和当前场景处理。
...
2. `.novel/style-anchor.md` 或对标书 `benchmark/{书名}/文风.md`，确认句长、声线和段落节奏。
