...
不同题材的真实文风 cadence 会影响读感；有效写法不同。男频/军旅可以借旧网文连贯叙事惯性，现代日常可写普通任务推进；悬疑、科幻、古代不要硬套盘龙腔、旧网文腔或第一人称声口，先读 `.novel/style-anchor.md`、对标拆文（`deconstruct/` 或 `benchmark/`）和匹配章摘要。
