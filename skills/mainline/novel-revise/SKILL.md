...
- `references/editor-checklist.md` 六条：伏笔一致/知情边界/时间线/称谓与数字/状态连续/钩子落点
- `references/craft-canon.md` 红线 12 条：机械降神/信息倾倒/无后果/崩人设/误会驱动/工具人/说教/陈词滥调/视角漂移/节奏失衡/主角无能动性/章内无变化
