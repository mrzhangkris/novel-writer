...
| 经典作品拆解 | Stage 1-2 | benchmark拆解参考框架 |
| 拆书实操技巧 | Stage 2（逐章摘要）| 情绪折线图、期待分析 |
| benchmark书选择 | Stage 0（概要提取）| 确定拆解对象 |
...
| 错误 | 原因 |
|------|------|
| 只拆一本benchmark书 | 至少5本同网站同题材同类型参考 |
| 只拆唯一头部爆款 | 头部作品可能依赖不可复制的作者品牌或历史流量，优先选择同平台同题材、数据稳定、非唯一头部的可复制样本 |
| 跨网站benchmark | 不同网站读者群体不同，写法差异大 |

流程：广泛收集同题材样本→定方向→定参考书5-10本→定benchmark书
