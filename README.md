...
- **事实状态机**：每章写完提交 CHANGES 事务申报「本章改变了什么」（12 类变更：角色/情节/伏笔/时间线双视图/道具/秘密/誓约/约束/下章承诺/能力/规则突破/结果），脚本过六道门禁（G1 协议/G2 引用/G3 一致性/G4 未知实体/G5 描写/G6 履约）后合并进状态账本——一致性靠申报-校验-合并循环，不靠模型记忆
